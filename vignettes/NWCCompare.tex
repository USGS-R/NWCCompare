...
{\ttfamily\noindent\color{warningcolor}{Warning: replacing previous import by 'hydroGOF::rmse' when loading 'NWCCompare'\\Warning: replacing previous import by 'hydroGOF::rsr' when loading 'NWCCompare'}}

{\ttfamily\noindent\itshape\color{messagecolor}{\\Attaching package: 'NWCCompare'

The following objects are masked from 'package:EflowStats':

\ \ \ \ obs\_data, qfiletempf, sampleData}}\end{kframe}
\end{knitrout}
