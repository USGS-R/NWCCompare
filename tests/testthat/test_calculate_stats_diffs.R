...
test_that("Original demo for for diff stats works", {
  ...
  flow_data_a <- build_nwis_dv_dataset(nwis_sites, start_date = startdate, end_date = enddate)
  flow_data_b <- build_nwc_flow_dataset(hucs, start_date = startdate, end_date = enddate)
